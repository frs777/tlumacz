...
Ten tekst zawiera notkę[^1] i kolejną[^note].
...
Ten akapit zawiera **tekst pogrubiony**, *tekst kursywa*, `code` i [link](https://example.com) wszystkie razem.

> **Uwaga:** To jest **uwaga** w formacie pogrubionym, z *kursywą* i `code`.

1. **Pierwszy** element z *kursywą*
2. *Drugi* element z **pogrubionym**
