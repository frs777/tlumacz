...
PL = {
    ...
    # Etykiety ustawień
    "settings.base_url": "Adres URL serwera:",
    "settings.api_key": "Klucz API:",
    "settings.model": "Typ serwera:",
    ...
    "log.processing_blocks": "Przetwarzanie {count} blok(ów) z parallel={parallel}...",
    "log.parallel_translation": "Tłumaczenie równoległe: {parallel} wątków, {segments} bloków...",
    "log.translating_block": "Tłumaczenie bloku {current}/{total}...",
    "log.completed_block": "Ukończono {current}/{total} bloków...",
    ...
    "log.translation_speed": "Prędkość tłumaczenia: {speed} znaków/s",
    # Logi - bufor
...
EN = {
    ...
    "log.processing_blocks": "Processing {count} block(s) with parallel={parallel}...",
    "log.parallel_translation": "Parallel translation: {parallel} threads, {segments} blocks...",
    "log.translating_block": "Translating block {current}/{total}...",
    "log.completed_block": "Completed {current}/{total} blocks...",
    "log.translating_segment": "Translating chunk {current}/{total}...",
    "log.translation_cancelled": "Translation cancelled by user.",
    "log.translation_saved": "Translation saved to: {path}",
    "log.translation_speed": "Translation speed: {speed} chars/s",
    # Logs - buffer/cache
