...
PL = {
    ...
    "settings.parallel": "Równoległość:",
    "settings.auto_start": "Auto-start serwera",
    "settings.clear_cache": "Czyść bufor po tłumaczeniu",
...
EN = {
    ...
    "settings.auto_start": "Auto-start server",
    "settings.clear_cache": "Clear cache after translation",
