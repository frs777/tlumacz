...
_INT_FIELDS = {"chunk_size", "server_port", "server_parallel", "fastapi_port", "fastapi_parallel"}
_FLOAT_FIELDS = {"temperature"}
_BOOL_FIELDS = {"auto_start_server", "cache_clear_after_translation", "restart_after_translation"}
...
class AppSettings:
    ...
    restart_after_translation: bool = False
    ...
    # Backend tłumaczenia
    backend_type: str = "llama"  # "llama", "cloud", "fastapi"
